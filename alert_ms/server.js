...
function scoreDropRisk(features) {
  ...
  if (minAcceleration < 6) score += 25; if (minAcceleration < 3) score += 15;
  if (peakRotationRate > 100) score += 20; if (peakRotationRate > 180) score += 10;
  if (peakAcceleration > 12) score += 25; if (peakAcceleration > 18) score += 15;
  const hadImpact = minAcceleration < 6 || peakAcceleration > 12 || peakRotationRate > 100;
